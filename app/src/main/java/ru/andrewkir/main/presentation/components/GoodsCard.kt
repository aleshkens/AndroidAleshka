      ...
      FlowRow(modifier = Modifier.width(120.dp)) {
        for (i in 1..5) {
          Icon(
            ...
            contentDescription = null,
            tint = if (i <= item.condition && item.condition == 5) {
              Color.Cyan
            } else if (i <= item.condition && item.condition == 4) {
              Color.Green
            } else if (i <= item.condition && item.condition == 3) {
              Color.Yellow
            } else if (i <= item.condition && item.condition == 2) {
              Color.Red
            } else if (i <= item.condition) {
              Color.Black
            } else {
              Color.Transparent
            }
